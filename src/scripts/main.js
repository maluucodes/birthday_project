...
const dataDoEvento = new Date("May 22, 2026 15:00:00");
...
const contaOTempo = setInterval(function() {
    ...
    document.getElementById('timer').innerHTML = `${diasAteEvento}d ${horasAteEvento}h ${minutosAteEvento}m ${segundosAteEvento}s`;

    if (distanciaAteEvento < 0) {
        clearInterval(contaOTempo);
        document.getElementById('timer').innerHTML = 'Já acabou :(';
    }
}, 1000);
